...
export default function CoinBagIcon ({ width, height, fill }) {
  return (
    ...
    >
      ...
      <path fill='currentColor' d='M21.6 28.5a1 1 0 0 0-1-1h-6a1 1 0 0 0 0 2h6a1 1 0 0 0 1-1Z' />
      <path fill='currentColor' d='M22.54 23.5h-6a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2Z' /><path fill='currentColor' d='M22 31.5h-6a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2Z' />
      <path fill='currentColor' d='M32.7 31.5h-7a1 1 0 0 0 0 2h7a1 1 0 0 0 0-2Z' /><path fill='currentColor' d='M33.7 27.5h-7a1 1 0 0 0 0 2h7a1 1 0 0 0 0-2Z' />
